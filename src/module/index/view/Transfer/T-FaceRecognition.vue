<template>
  <div id="T-FaceRecognition">
    ...
    <div class="edition-table">
      <AllEditionTab :editionDataSon="editionData"
...
<script>
  ...
  import AllEditionTab from '../../../.././components/allEditionTab'
    ...
    data() {
      return {
        ...
        editionData: [{
          ...
          editionName: 'Main API 1'
        }, {
          editionName: 'Main API 2'
        }, {
          editionName: 'uninit'
        }, {
          editionName: '1:N(小)-init'
        }, {
          editionName: 'Main API 1'
        }, {
          editionName: 'Main API 1'
